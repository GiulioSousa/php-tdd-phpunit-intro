...
class Leilao
{
    ...
    public function recebeLance(Lance $lance)
    {
        if (!empty($this->lances) && $this->ehDoUltimoUsuario($lance)) {
            // return;
            throw new DomainException('Usuário não pode efetuar 2 lances consecutivos.');
        }
        ...
        if ($totalLancesUsuario >= 5) {
            // return;
            throw new DomainException('Usuário não pode efetuar mais de 5 lances por leilão.');
        }
